...
//   // document.getElementById('get-repositories').addEventListener('click', function(event){
...
//   const commitsList = `<ul>${commits.map(thing => '<li><strong>' + thing.commit.committer.name + '</strong> - ' + thing.author.login + thing.commit.message + '</li>').join('')}</ul>`
