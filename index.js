...
function displayRepositories(event, data){
	...
	console.log(repos);
	const repoList = `<ul>${repos.map(r => '<li>' + r.name + ' - ' + r.html_url + '<a href="#" data-username="' + r.owner.login + '"data-repository="' + r.name + '"onclick="getCommits(this);"> Get Commits</a> <a href="#" data-username="' + r.owner.login + '"data-repo="' + r.name + '"onclick="getBranches(this);"> Get Branches</a></li>').join("")}</ul>`
